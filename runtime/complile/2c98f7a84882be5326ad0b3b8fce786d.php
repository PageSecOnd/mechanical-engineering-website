    ...
    <div class="NyContactUs_Infor">
	    <div class="NyContactUsInfor_Main">        
            <div class="NyContactUsInfor_Img">
            	<img src="{pboot:sitedomain}/skin/images/contactimg.jpg" class="contactImg" />
            ...
            <div class="NyContactUsInfor_Con">
            	<div class="NyContactUs_Ewm">
                	<span><img src="{pboot:companyweixin}" /></span><p>公众号二维码</p>
                </div>
                <div class="NyContactUs_Lxfs">
                	<ul>
                    	<li>
                        	<img src="{pboot:sitedomain}/skin/images/lxico1.png" />
                            <span>公司电话</span><p>{pboot:companyphone}</p>
                        </li>
                        <li>
                        	<img src="{pboot:sitedomain}/skin/images/lxico2.png" />
                            <span>公司邮箱</span><p>{pboot:companyemail}</p>
                        </li>
                        <li>
                        	<img src="{pboot:sitedomain}/skin/images/lxico3.png" />
                            <span>公司地址</span><p>{pboot:companyaddress}</p>
                        </li>
                        <div class="clear"></div>
                    </ul>
                </div>
