...
<div class="NyCrumb"> <i></i>
  <div class="NyCrumb_Main">
    <ul>
      <li class="NyActive"><a href="#ab01">公司概况</a></li>
      <li><em></em></li>
      <li><a href="#ab02">企业文化</a></li>
      <li><em></em></li>
      <div class="clear"></div>
    </ul>
  ...
  <div class="NyAboutus_Profile">
    <div class="abGsjj_main">
      <div class="ab_Title1">
        <p>公司概况</p>
        <span><i></i></span></div>
      <div class="abGsjj_con">
        <div class="abGsjj_name">
          <p>{pboot:companyname}</p>
          <i></i></div>
        <div class="abGsjj_ms ab_img">
          {content:content}
        </div>
        <ul>
          <li>
            <p>{label:chengli}</p>
            <span>{label:chengli}年公司成立</span></li>
          <li>
            <p>{label:zijin}</p>
            <span>注册资金{label:zijin}万</span></li>
          <li>
            <p>365</p>
            <span>365天 用心服务每一天</span></li>
          <div class="clear"></div>
        </ul>
      </div>
      <div class="abGsjj_img"><img src="{content:ico}" /></div>
      <div class="clear"></div>
    </div>
    <div id="ab02"></div>
  </div>
  <div class="NyAboutus_Culture">
    <div class="NyAbCulture_Main">
      <div class="ab_Title1 ab_Title2">
        <p>企业文化</p>
        <span><i></i></span></div>
      <ul>
        <li>
          <div class="NyAbCulture_Con"> <i class="AbIco2"></i>
            <p>我们的使命</p>
            <em></em> <span>为客户保驾护航，为您提供更好的服务，我们一直在努力</span> </div>
        </li>
        <li>
          <div class="NyAbCulture_Con"> <i class="AbIco3"></i>
            <p>我们的经营理念</p>
            <em></em> <span>提供有竞争力的解决方案和服务持续创造客户价值</span> </div>
        </li>
        <li>
          <div class="NyAbCulture_Con"> <i class="AbIco4"></i>
            <p>我们的价值观</p>
...
<script>
  $(function () { $(".NyAboutusHonor_List ul li").first().addClass('active'); });

  $(".NyAboutusHonor_List ul li span").click(function () {
