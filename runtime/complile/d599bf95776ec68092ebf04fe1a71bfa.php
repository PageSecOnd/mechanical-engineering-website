...
.NyPro_Right ul li{ width:25%}
@media screen and (max-width: 768px) {
   .NyPro_Right ul li{ width:50%}
}
</style>
</head>
...
<div class="NyCrumb"> <i></i>
  <div class="NyCrumb_Main">
    <ul>
      <li {pboot:if('{sort:scode}'=='{sort:tcode}')}class="NyActive"{/pboot:if}><a href="{sort:toplink}">全部</a></li>
      {pboot:nav num=50 parent={sort:tcode}}
      <li {pboot:if('[nav:scode]'=='{sort:scode}')}class="NyActive"{/pboot:if}><a href="[nav:link]">[nav:name]</a></li>
      {/pboot:nav}
      <div class="clear"></div>
    </ul>
  ...
  <div class="abFoot_main w1400">
    <div class="abFoot_left">
      <div class="abFoot_copy">
        ...
        <p><a href="https://beian.miit.gov.cn/" rel="nofollow" target="_blank">{pboot:siteicp}</a> <a href="{pboot:sitedomain}/index.php/sitemap.xml" target="_blank">XML</a> <a href="https://www.adminbuy.cn" target="_blank">网站模板</a></p>
      </div>
    </div>
