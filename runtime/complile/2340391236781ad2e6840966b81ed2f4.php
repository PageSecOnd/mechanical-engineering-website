...
<script src="{pboot:sitedomain}/skin/js/common.js" type="text/javascript"></script>
...
<div class="abTop nyTop">
  <div class="abTop_Main">
    <div class="ab_Logo"> <a href="{pboot:sitedomain}/"><img src="{pboot:sitelogo}" alt="{pboot:sitetitle}" /></a> </div>
    <div class="abSearch">
      <form action="{pboot:scaction}" method="get">
        ...
        <div class="scBtn">
          <button type="submit"> <i> <svg t="1724225171400" class="icon" viewBox="0 0 1024 1024" version="1.1"
      ...
      <a href="javascript:;" class="close"> <svg t="1728637373488" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4255"
      ...
      <path
              ...
              fill="#2c2c2c" p-id="4256"></path>
      </svg> </a> </div>
    <div class="abSearch_btn"> <a href="javascript:;"> <i> <svg t="1724225171400" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="5242" width="200" height="200">
      <path
                d="M940.288 881.872L776.56 721.008c137.584-155.376 127.936-390.496-20.624-533.504-156.832-154-408.576-154-566.784 0C36.448 336 32.336 580.752 180.896 733.376l8.256 8.272c143.072 137.488 365.92 152.608 525.504 34.368l165.088 162.24c6.88 8.256 17.872 12.384 28.896 13.744 11.008 0 22-4.128 30.256-12.368a39.872 39.872 0 0 0 1.392-57.76zM156.144 463.872C158.88 292 300.592 154.496 473.92 155.872c171.952-1.376 312.288 136.128 316.4 308-2.768 171.872-144.448 309.376-316.4 308.016-173.328 2.736-315.04-134.768-317.776-308.016z"
                fill="#ffffff" p-id="5243"></path>
      </svg> </i> </a> </div>
...
<div class="NyBanner"> <img src="[sort:pic]" class="nyBa_Img" />
  <div class="NyBa_Con">
    <p>[sort:name]</p>
    <i></i><span>[sort:subname]</span></div>
</div>
{/pboot:sort}
<div class="NyCrumb"> <i></i>
  <div class="NyCrumb_Main">
    <ul>
      <li class="NyActive"><a>{sort:topname}</a></li>
      <div class="clear"></div>
    </ul>
...
<div class="NyProDetail">
  <div class="NyProDetail_Main">
    <div class="NyProDetail_Img prodetail_img">
      <div id="preview">
        {pboot:pics id={content:id} num=1}
        <div class="jqzoom" id="spec-n1">
          <div id="ceshi" style=""> <img src="[pics:src]" jqimg="[pics:src]" /> </div>
        </div>
        {/pboot:pics}
        <div id="spec-n5">
          <div id="spec-list">
            <ul class="list-h">
              {pboot:pics id={content:id} num=4}
              <li>
                <p {pboot:if([pics:i]==01)}style="border: 1px solid rgb(18, 75, 83);"{/pboot:if}><img onclick="jQuery('.videoItem').hide();mybaidu.window.SetPause();" src="[pics:src]" alt="" data-zoom-image="[pics:src]" onload="DrawImage(this,460,300)"></p>
              </li>
              {/pboot:pics}
            </ul>
          </div>
      ...
      <script type="text/javascript" src="{pboot:sitedomain}/skin/js/zzsc.js"></script> 
    </div>
    <div class="NyProDetail_Text">
      <div class="NyProDetail_Name">{content:title}</div>
      <h1 class="NyProDetail_Ms"> <span><img src="{pboot:sitedomain}/skin/images/ico10.png" />产品简介</span>
        <p>{content:description lencn=100}</p>
      </h1>
      <div class="NyProDetail_Tags">
        <dl>
          <dd><i></i>产品型号：{content:ext_xinghao}</dd>
          <dd><i></i>更新时间：{content:date style=Y-m-d}</dd>
          <dd><i></i>钢材型号：{content:ext_xingzhi}</dd>
          <dd><i></i>访问量：{content:visits}</dd>
          <div class="clear"></div>
        </dl>
      </div>
      <div class="NyProDetail_Btm"> <a href="#cpzx" class="Btn01"><i><em></em></i><span>产品咨询</span></a> <a href="tel:{pboot:companyphone}" class="Btn02"><i><em></em></i><span>{pboot:companyphone}</span></a>
        <div class="clear"></div>
      </div>
    </div>
    <div class="clear"></div>
  ...
  <div class="NyProDetail_Content">
    <div class="NyProDetail_Left">
      <div class="h_left">
        ...
        {pboot:sort scode={sort:tcode}}
        <div class="hd">
          <p><img src="{pboot:sitedomain}/skin/images/proico1.png" />[sort:name]</p>
          <span>[sort:subname]</span><em></em><i></i></div>
          {/pboot:sort}
        <div class="bd">
          <ul>
            {pboot:nav num=10 parent={sort:tcode}}
            <li {pboot:if('[nav:scode]'=='{sort:scode}')}class="on"{/pboot:if}>
              <p><a href="[nav:link]" >[nav:name]</a><span></span></p>
              <div>
    ...
    <div class="NyXgwz">
      <div class="NyXgwz_Title">
        <p><img src="{pboot:sitedomain}/skin/images/artico.png" />[sort:name]</p>
        <span>[sort:subname]</span><em></em></div>
      <div class="NyXgwz_List">
        <dl>
          {pboot:list scode=[sort:scode] num=5 order=sorting}
          <dd><a href="[list:link]"><i></i>[list:title]</a></dd>
          {/pboot:list}
        </dl>
      </div>
    </div>
    ...
    <script type="text/javascript" src="{pboot:sitedomain}/skin/js/pt_js.js"></script>
    <div class="NyProDetail_Right">
      <div class="NyProDetail_Con">
        <div class="NyProDetail_Tit"><span>详细介绍</span><a href="#cpzx">在线留言</a>
          <div class="clear"></div>
        </div>
        <div class="ProDetailText ab_img">
		{content:content}
        </div>
      </div>
      <div id="cpzx"></div>
      <div class="NyPro_PrevNext">
        <p class="NyProPrev"><img src="{pboot:sitedomain}/skin/images/jt11.png" />上一个：<a href="{content:prelink}">{content:pretitle}</a></p>
        <a href="{sort:link}" class="NyProAll"><img src="{pboot:sitedomain}/skin/images/proall.png" />返回列表</a>
        <p class="NyProNext">下一个：<a href="{content:nextlink}">{content:nexttitle}</a><img src="{pboot:sitedomain}/skin/images/jt0.png" /></p>
        <div class="clear"></div>
      </div>
      <div id="cpzx"></div>
            ...
            <ul>
              ...
              <li>
                ...
                <div class="msg_ipt12 msg_ipt0">
                  <textarea class="areatext" style="width:100%;" name="content" rows="8" cols="65" id="content"  placeholder="请输入您的任何要求、意见或建议"></textarea>
                </div>
              </li>
              <li>
                <h4 class="xh">验证码：</h4>
                <div class="msg_ipt2">
                  <div class="c_yzm">
                    <input class="textborder" size="4" name="checkcode" id="checkcode"/>
                    <a href="javascript:void(0);" class="yzm_img"><img src="{pboot:checkcode}" title="点击刷新验证码" onclick="this.src='{pboot:checkcode}?'+Math.round(Math.random()*10);" height="60" /></a> </div>
                  </div>
              </li>
              <li>
                <h4></h4>
...
<!--NyProDetail 结束--> 
<div class="abFoot wow fadeInUp">
  <div class="abFoot_lxfs w1400">
    <ul>
      <li> <i> <svg t="1728550903860" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="29332" width="200" height="200">
        <path
                d="M512 639.9c-16.6 0-33.2-5-47.4-14.9L34.9 324.3v535.2c0 32.1 26.1 58.2 58.2 58.2h837.8c32.1 0 58.2-26.1 58.2-58.2V324.3L559.4 625.1c-14.2 9.9-30.8 14.8-47.4 14.8z"
                p-id="29333" fill="#ffffff"></path>
        <path
                d="M519.4 567.9l469.7-328.8v-3c0-32.1-26.1-58.2-58.2-58.2H93.1c-32.1 0-58.2 26.1-58.2 58.2v3l469.7 328.8c4.5 3 10.3 3 14.8 0z"
                p-id="29334" fill="#ffffff"></path>
        </svg> </i>
        <p> <em>公司邮箱：</em> <span>{pboot:companyemail}</span> </p>
      </li>
      <li> <i> <svg t="1728550566381" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="19580" width="200" height="200">
        <path
                d="M808.973 1019.51h-7.68c-132.581 0-401.154-133.518-532.194-264.572C138.01 623.898 4.491 355.275 4.491 222.722v-7.707l4.26-6.394C40.72 160.745 150.502 4.491 222.71 4.491c60.317 0 183.773 112.094 220.127 199.868 22.08 53.354 7.162 84.13-9.318 100.61-26.614 26.638-53.254 43.069-74.663 56.327-34.545 21.31-46.44 29.959-46.44 54.295 0 53.75 61.556 115.329 121.103 174.903 59.597 59.574 121.154 121.126 174.928 121.126 24.335 0 32.96-11.943 54.271-46.438 13.232-21.41 29.686-48.074 56.347-74.688 13.333-13.332 31.127-20.368 51.497-20.368 92.68 0 248.947 157.555 248.947 231.165 0 72.26-156.268 182.042-204.143 213.957l-6.393 4.262z"
                p-id="19581" fill="#ffffff"></path>
        </svg> </i>
        <p> <em>服务热线：</em> <span>{pboot:companyphone}</span> </p>
      </li>
      <li> <i> <svg t="1728550924009" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="30367" width="200" height="200">
        <path
                ...
                fill="#ffffff" p-id="30368"></path>
        </svg> </i>
        <p> <em>公司地址：</em> <span>{pboot:companyaddress}</span> </p>
      </li>
    </ul>
  </div>
  <div class="abFoot_main w1400">
    <div class="abFoot_left">
      <div class="abFoot_copy">
        <p>{pboot:sitecopyright} {pboot:sitestatistical}</p>
 
      </div>
    </div>
    <div class="abFoot_nav">
      <ul>
        {pboot:sort scode=2}
        <li>
          <p>[sort:name]</p>
          {pboot:nav parent={sort:tcode} parent=2 num=4}
          <a href="[nav:link]"> <i> <svg t="1723013587145" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <p>[sort:name]</p>
          {pboot:nav parent={sort:tcode} parent=15 num=4}
          <a href="[nav:link]"> <i> <svg t="1723013587145" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                  p-id="68804" width="200" height="200">
          <path
                    d="M677.59360603 511.63822677l-429.6498252 429.65717831c-18.05630764 18.04454264-18.05630764 47.33346775 0 65.37948104 18.04454264 18.05630764 47.33346775 18.05630764 65.37948103-1e-8l462.34471289-462.34765412c18.06071949-18.04454264 18.06071949-47.33346775 0-65.37948103l-462.34618352-462.34618354c-9.02521257-9.02962444-20.8578442-13.54590727-32.68900521-13.54590727s-23.66526327 4.51628285-32.68900519 13.54590727c-18.06071949 18.04454264-18.06071949 47.33346775 0 65.37948103l429.65276643 429.65864894z"
    ...
    <div class="abFoot_ewm">
      <p><img src="{pboot:companyweixin}" width="145" /></p>
      <span>公众号二维码</span> </div>
    <div class="clear"></div>
  </div>
</div>
<div class="abView">
  <div class="abView_ewm"> <i> <svg t="1723195636381" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <p><img src="{pboot:companyweixin}" /></p>
  </div>
  <div class="abView_tel"> <i> <svg t="1723194880104" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
  ...
  <div class="abView_tel mobile_tel"> <a href="tel:{pboot:companyphone}"> <i> <svg t="1723194880104" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id