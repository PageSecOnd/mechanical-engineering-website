...
<div class="NyNewDetail">
  <div class="NyNewDetail_Main">
    <h1 class="NyNewDetail_Name">{content:title}</h1>
    <div class="NyNewDetail_Tips"> <span><img src="{pboot:sitedomain}/skin/images/ico04.png" />更新时间：{content:date style=Y-m-d}</span><span><img src="{pboot:sitedomain}/skin/images/ico05.png" />点击次数：{content:visits}</span> </div>
...
<div class="NyPrevNext">
  <ul>
    <li><i>上一条</i>{content:precontent}</li>
    <li><i>下一条</i>{content:nextcontent}</li>
  </ul>
</div>
<!--NyNewDetail 结束--> 
