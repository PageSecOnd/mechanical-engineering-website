...
<meta name="author" content="www.adminbuy.cn k639" />
<link rel="stylesheet" type="text/css" href="{pboot:sitedomain}/skin/css/common.css">
<link rel="stylesheet" type="text/css" href="{pboot:sitedomain}/skin/css/abstyle.css">
...
<div class="abBanner">
  <div class="abBa_swiper">
    <div class="swiper-container">
      <div class="swiper-wrapper">
        {pboot:slide gid=1 num=10}
        <div class="swiper-slide"><img src="[slide:src]" /></div>
        {/pboot:slide}
      </div>
      <div class="swiper-pagination"></div>
      <div class="swiper-button-prev"> <svg t="1723013571359" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="swiper-button-next"> <svg t="1723013587145" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
...
{pboot:sort scode=2}
<div class="abProRec">
  <div class="abProRec_main w1400">
    <div class="abTitle"> <span>RECOMMENDED PRODUCTS</span>
      <p>推荐产品</p>
    </div>
    <div class="abProRec_list">
      <ul>
        {pboot:list scode=[sort:scode] num=4 order=sorting isrecommend=1}
        <li>
          <div class="abProRec_con">
            <div class="abProRec_img"> <a href="[list:link]"><img src="[list:ico]" alt="[list:title]" /></a> </div>
            <div class="abProRec_text"> <a href="[list:link]" class="abProRec_name">[list:title]</a>
              <p>[list:description lencn=40]</p>
              <a href="[list:link]" class="abProRec_btn"> <i> <svg t="1728370883660" class="icon" viewBox="0 0 1027 1024" version="1.1"
          xmlns="http://www.w3.org/2000/svg" p-id="16548" width="200" height="200">
              <path
            d="M286.372864 473.019392l138.845184 264.991744c0 0 225.627136-538.53184 581.4272-718.04416C997.963776 148.18816 963.254272 259.315712 1024 396.08832 867.795968 430.27968 546.709504 814.948352 442.576896 1003.008 295.05024 823.491584 121.490432 686.724096 0 643.984384L286.372864 473.019392z"
            p-id="16549" fill="#124b53"></path>
              </svg> </i> </a> </div>
          </div>
        </li>
         {/pboot:list}
...
{pboot:sort scode=1}
<div class="abAbout">
  <div class="abAbout_main w1400">
    <div class="abAbout_left">
      <div class="abTitle abTitle1"> <span>[sort:subname]</span>
        <p>[sort:name]</p>
      </div>
      <div class="abAbout_con">{pboot:content scode=1}[content:content drophtml=1 dropblank=1 len=300 more='...']{/pboot:content}</div>
      <a href="[sort:link]" class="abAbout_btn"> 查看详情 <i> <svg t="1728375336767" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="97363" width="200" height="200">
      <path
                d="M818.778353 576H64.030118v64h827.361882c30.208 0 45.357176-36.532706 23.973647-57.916235l-252.687059-252.687059-45.266823 45.236706 201.366588 201.366588z"
                p-id="97364" fill="#ffffff"></path>
      </svg> </i> </a> </div>
    <div class="abAbout_right">
      {pboot:content scode=1}<div class="abAbout_img"> <a href="[content:link]"><img src="[content:ico]" /></a> </div>{/pboot:content}
    </div>
  </div>
</div>
{/pboot:sort}
{pboot:sort scode=2}
<div class="abProducts">
  <div class="abProducts_main w1400">
    <div class="abTitle"> <span>[sort:subname]</span>
      <p>[sort:name]</p>
    </div>
    <div class="abProducts_menu wow fadeInUp">
      <div class="abProMenu_title"> <i> <svg t="1728378502883" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="131718" width="200" height="200">
        <path
                d="M51.2 782.7456L476.16 1024v-482.56L51.2 300.1856v482.56z m496.64-241.2544V1024l424.96-241.2544V300.1856zM509.8496 0L87.4496 245.0944l426.7008 237.4144 422.4-245.0944z"
                fill="#ffffff" p-id="131719"></path>
        </svg> </i>[sort:name] </div>
      <div class="abProMenu_list"> {pboot:nav parent={sort:tcode} parent=2 num=4} <a href="[nav:link]">[nav:name]</a> {/pboot:nav}</div>
      <div class="abProMenu_more"> <a href="[sort:link]"> 查看全部 <i> <svg t="1728375336767" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="97363" width="200" height="200">
        <path
                  d="M818.778353 576H64.030118v64h827.361882c30.208 0 45.357176-36.532706 23.973647-57.916235l-252.687059-252.687059-45.266823 45.236706 201.366588 201.366588z"
                  p-id="97364" fill="#ffffff"></path>
        </svg> </i> </a> </div>
...
{/pboot:sort}
{pboot:sort scode=15}
<div class="abArticles">
  <div class="abArticles_main w1400">
    <div class="abTitle abTitle2"> <span>[sort:subname]</span>
      <p>[sort:name]</p>
    </div>
    <div class="abArticles_swiper">
      <div class="swiper-container">
        <div class="swiper-wrapper">
          {pboot:list scode=[sort:scode] num=12 order=sorting}
          <div class="swiper-slide">
            <div class="abArticles_con"> <span class="abArticles_time">[list:date style=Y-m-d]</span> <a href="[list:link]" class="abArticles_name">[list:title]</a>
              <div class="abArticles_ms">
                <p>[list:description lencn=40]</p>
              </div>
              <a href="[list:link]" class="abArticles_more"> 查看详情 <i> <svg t="1728375336767" class="icon" viewBox="0 0 1024 1024" version="1.1"
                      xmlns="http://www.w3.org/2000/svg" p-id="97363" width="200" height="200">
              <path
                        d="M818.778353 576H64.030118v64h827.361882c30.208 0 45.357176-36.532706 23.973647-57.916235l-252.687059-252.687059-45.266823 45.236706 201.366588 201.366588z"
                        p-id="97364" fill="#ffffff"></path>
...
{/pboot:sort}
<div class="abPartner w1400">
  <div class="abPartner_swiper">
    <div class="swiper-container">
      <div class="swiper-wrapper">
        {pboot:list scode=21 num=12 order=sorting}
...
<div class="abLinks">
  <div class="abLinks_main w1400">
    <div class="abLinks_title"> <i> <svg t="1728547055494" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="4440" width="200" height="200">
      <path
      ...
      <path
              ...
              p-id="4442" fill="#ffffff"></path>
      </svg> </i>友情链接： </div>
    <div class="abLinks_list"> {pboot:link gid=1 num=100}<a href="[link:link]" target="_blank">[link:name]</a>{/pboot:link}</div>
  </div>
</div>
</body>
</html>
<?php return array (
  0 => '/www/wwwroot/mykygcjx/template/dafeult/foot.html',
); ?>